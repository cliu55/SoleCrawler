...
export const registerHandlers = assistant => {
    ...
    assistant.intent('releases.all.next', allReleases);
    assistant.intent('releases.all.previous', allReleases);
    assistant.intent('releases.brand', releasesByBrand);
    assistant.intent('releases.brand.next', releasesByBrand);
    assistant.intent('releases.brand.previous', releasesByBrand);
